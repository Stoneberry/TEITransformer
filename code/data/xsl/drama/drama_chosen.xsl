...
<xsl:stylesheet version = "1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- <xsl:template match = "/"> 
    ...
    <xsl:template match="tei_ns:titleStmt/tei_ns:author">
      <p class="author" id="{generate-id(.)}">
    ...
    <xsl:template match="tei_ns:author/text()">
      <xsl:value-of select="."/>
    </xsl:template>
  ...
  <!-- Core elements  -->
    ...
    <xsl:template match="tei_ns:castItem/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:roleDesc/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:role/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:actor/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:camera/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:sound/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:caption/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:tech/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:view/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:set/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:set/tei_ns:p/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:pb/text()">
      <xsl:value-of select="."/>
    </xsl:template>
    ...
    <xsl:template match="tei_ns:head/text()">
      <xsl:value-of select="."/>
    </xsl:template>
